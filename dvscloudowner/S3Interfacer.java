...
File f=new File(key);
        ...
        s3.putObject(new PutObjectRequest("mydvsbkt", f.getName(), new File(filename)));

        Main.instance.writetolog("Uploaded the file: " + filename + " to cloud in bucket mydvsbkt");
    ...
    void downloadFileFromCloud(String filename, String key) {
        ...
        S3Object object = s3.getObject(new GetObjectRequest("mydvsbkt", key));
